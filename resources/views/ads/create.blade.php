                        ...
                        <div class="card-body">
                            ...
                            <div class="form-inline form-group mt-1">
                                ...
                                <div class="col-md-4 mt-2">
                                    <img id="showFeatureImage" width="150" height="150"
                                        src="{{ Storage::url($no_image) }}" alt="">
                                    <input type="file" class="mt-2" name="featureImage" id="featureImage"
                                        style="width: 100%;">
                                </div>
                                <div class="col-md-4 mt-2">
                                    <img id="showFirstImage" width="150" height="150" src="{{ Storage::url($no_image) }}"
                                        alt="">
                                    <input type="file" class="mt-2" name="firstImage" id="firstImage" style="width: 100%;">
                                </div>
                                <div class="col-md-4 mt-2">
                                    <img id="showSecondImage" width="150" height="150" src="{{ Storage::url($no_image) }}"
                                        alt="">
                                    <input type="file" class="mt-2" name="secondImage" id="secondImage"
                                        style="width: 100%;">
                                </div>
